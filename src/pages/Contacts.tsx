...
const Contacts = () => {
  ...
  const socials = [
    { name: "MAX", icon: "MessageCircle", color: "from-blue-500 to-blue-600" },
            ...
            <div className="grid grid-cols-2 gap-4 mb-8">
              {socials.map((social, index) => (
                ...
                >
                  <CardContent className="p-6 text-center">
                    <div
                      className={`w-12 h-12 bg-gradient-to-br ${social.color} rounded-xl flex items-center justify-center mx-auto mb-3 group-hover:scale-110 transition-transform shadow-lg`}
                    >
                      <Icon
            ...
            <Card className="bg-gradient-to-br from-primary to-secondary border-0 shadow-2xl shadow-primary/30">
              <CardContent className="p-6 text-center text-white">
                ...
                <p className="mb-4 text-white/90">
                  Всегда готовы помочь с выбором и настройкой оборудования
                </p>
